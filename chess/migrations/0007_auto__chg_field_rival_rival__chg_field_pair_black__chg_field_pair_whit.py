...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rival.rival'
        db.alter_column(u'chess_rival', 'rival_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chess.Player'], null=True))

        # Changing field 'Pair.black'
        db.alter_column(u'chess_pair', 'black_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['chess.Player']))

        # Changing field 'Pair.white'
        db.alter_column(u'chess_pair', 'white_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['chess.Player']))

    def backwards(self, orm):

        # Changing field 'Rival.rival'
        db.alter_column(u'chess_rival', 'rival_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['chess.Player']))

        # Changing field 'Pair.black'
        db.alter_column(u'chess_pair', 'black_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['chess.Player']))

        # Changing field 'Pair.white'
        db.alter_column(u'chess_pair', 'white_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['chess.Player']))
