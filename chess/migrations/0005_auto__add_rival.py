...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rival'
        db.create_table(u'chess_rival', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('round_serial_number', self.gf('django.db.models.fields.IntegerField')()),
            ('round', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rivals', to=orm['chess.Round'])),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rivals', to=orm['chess.Player'])),
            ('rival', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chess.Player'])),
            ('score', self.gf('django.db.models.fields.FloatField')()),
            ('color', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'chess', ['Rival'])


    def backwards(self, orm):
        # Deleting model 'Rival'
        db.delete_table(u'chess_rival')
    ...
    models = {
        ...
        u'chess.rival': {
            ...
            'round_serial_number': ('django.db.models.fields.IntegerField', [], {}),
